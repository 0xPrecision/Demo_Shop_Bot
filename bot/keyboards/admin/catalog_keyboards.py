...
def admin_catalog_menu_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.kategorii"),
...
def product_edit_field_keyboard(product_id: int, t, **_) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.kategoriya"),
                    callback_data=f"edit_field:category:{product_id}",
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.ostatok"),
                    callback_data=f"edit_field:stock:{product_id}",
                )
            ],
            [
                InlineKeyboardButton(
...
def change_category_keyboard(categories: List["Category"]) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=cat.name, callback_data=f"change_category:{cat.id}"
                )
            ]
...
def show_products_or_edit_category(cat_id, t, **_) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.redaktirovat-kategoriyu"),
                    callback_data=f"admin_edit_category:{cat_id}",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.prosmotret-tovary"),
                    callback_data=f"admin_category_filter:{cat_id}",
                )
            ],
            [
                InlineKeyboardButton(
...
def edit_or_deletion_category(cat_id, t, **_) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.pereimenovat"),
                    callback_data=f"admin_rename_category_select:{cat_id}",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.udalit"),
                    callback_data=f"admin_delete_category_select:{cat_id}",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.nazad"),
                    callback_data=f"admin_select_category:{cat_id}",
                )
            ],
        ]
    )
...
def admin_categories_keyboard(
    categories: List["Category"], t, **_
) -> InlineKeyboardMarkup:
    """Клавиатура для отображения категорий"""
    buttons = [
        [
            InlineKeyboardButton(
                text=cat.name, callback_data=f"admin_select_category:{cat.id}"
            )
        ]
        for cat in categories
    ]
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=cat.name,
                    callback_data=f"admin_rename_category_select:{cat.id}",
                )
            ]
            for cat in categories
        ]
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=cat.name,
                    callback_data=f"admin_delete_category_select:{cat.id}",
                )
            ]
            for cat in categories
        ]
...
def confirm_deletion_category(cat_id: int, t, **_) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("catalog_keyboards.buttons.da-udalit"),
                    callback_data=f"admin_delete_category_yes:{cat_id}",
                )
            ],
            [
                InlineKeyboardButton(
