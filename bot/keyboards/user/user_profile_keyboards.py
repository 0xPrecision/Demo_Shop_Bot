...
def edit_profile_keyboard(t, **_):
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=t('user_profile_keyboards.buttons.fio'), callback_data='edit_profile_name')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.telefon'), callback_data='edit_profile_phone')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.adres'), callback_data='edit_profile_address')], [InlineKeyboardButton(text=t('catalog_keyboards.buttons.nazad'), callback_data='menu_profile')]])
