        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.sozdat-profil"),
                    callback_data="create_profile",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.v-menyu-profilya"),
...
def profile_confirm_or_edit_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.izmenit-dannye"),
...
def profile_menu_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.moi-zakazy"),
...
def profile_orders_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.tekuschie-zakazy"),
                    callback_data="active_orders",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_profile_keyboards.buttons.istoriya-zakazov"),
