...
def checkout_edit_keyboard(t, **_):
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.imya'), callback_data='edit_name')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.telefon'), callback_data='edit_phone')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.adres'), callback_data='edit_address')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.kommentarij'), callback_data='edit_comment')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.sposob-oplaty'), callback_data='edit_payment')], [InlineKeyboardButton(text=t('user_checkout_keyboards.buttons.sposob-dostavki'), callback_data='edit_delivery')], [InlineKeyboardButton(text=t('catalog_keyboards.buttons.nazad'), callback_data='back_to_confirm')]])
