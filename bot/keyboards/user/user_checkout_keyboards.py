...
def payment_methods_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.nalichnye"),
                    callback_data="pay_cash",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.yumoney"),
                    callback_data="pay_yoomoney",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.nazad-v-katalog"),
...
def delivery_methods_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.kurer"),
                    callback_data="delivery_courier",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.samovyvoz"),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t(
                        "user_checkout_keyboards.buttons.ispolzovat-adres-iz-profilya"
                    ),
                    callback_data="use_profile_address",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.vvesti-novyj-adres"),
...
def checkout_edit_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.telefon"),
                    callback_data="edit_phone",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.adres"),
            ...
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.sposob-dostavki"),
...
def profile_data_confirm_keyboard(t, **_):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.da-ispolzovat-profil"),
                    callback_data="use_profile",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("user_checkout_keyboards.buttons.zapolnit-zanovo"),
